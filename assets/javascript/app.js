$(document).ready(function(){
    ...
    $(addIngButton).click(function(event){
        ...
        if(x < maxField) {
            ...
            $(ingInputLine).append(newIngLine);
    ...
    // Function for REMOVE ingredient button which allows user to remove lines that they originally added.  Current code removes the very first line, need to figure out how to remove last line instead.
    $(removeIngButton).click(function(event){
        event.preventDefault();
        x--;
        $("#new-ingredient:last").remove();
